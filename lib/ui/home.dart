      ...
      TabBar(
        ...
        tabs: [
          Container(
            ...
            height: TAB_HEIGHT,
            child: Tab(child: Text(AppStr.MOVIES, style: TextStyle(fontSize: 20, color: Colors.white),),)
          ),
          Container(
            alignment: Alignment.center,
            height: TAB_HEIGHT,
            child: Tab(child: Text(AppStr.MOVIE_MARK, style: TextStyle(fontSize: 20, color: Colors.white),),)
          ),
        ],
        controller: _tabController,
